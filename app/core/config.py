...
def session_secret_is_weak(secret: str) -> bool:
    ...
    return (
        normalized.lower() in _INSECURE_SESSION_SECRETS or len(normalized) < _MIN_SESSION_SECRET_LEN
    )
...
class Settings(BaseSettings):
    ...
    # Публичная витрина: лендинг, страницы продукта и решений.
    # Внутреннему контуру она не нужна — там нет «клиентов», которым нужно
