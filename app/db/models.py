...
class UsageEvent(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "customer_id", "idempotency_key", name="uq_usage_events_customer_idempotency_key"
        ),
...
class DialogueArchive(Base):
    ...
    __table_args__ = (Index("ix_dialogue_archives_content_hash", "content_hash"),)
...
class TelegramLink(Base):
    ...
    __table_args__ = (
        Index("ix_telegram_links_customer_id", "customer_id"),
        Index("ix_telegram_links_chat_id", "chat_id"),
    )
...
class ResourceRequest(Base):
    ...
    status: Mapped[str] = mapped_column(
        Text, default="requested", server_default="requested", index=True
    )
